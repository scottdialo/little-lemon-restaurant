    ...
    <>
      ...
      <div className="about-container">
        <div className="left-section">
          ...
          <p>
            <p className="content">
              It all started in our great grand mother kitchen, Lorem ipsum
              dolor sit amet, consectetur adipisicing elit. Quas cumque enim,
              nulla necessitatibus eveniet incidunt impedit dolore laboriosam
              iusto nisi. Autem hic molestias ipsum ipsam fugit repellendus
              excepturi odit a. Labore voluptate ea inventore sapiente vel
              ducimus molestias
            </p>
          </p>
        </div>
        <div className="right-section">
          ...
          <img src={chef2} alt="founder2" className="founder2" />
        </div>
      </div>
